...
local function beta_text(obj)
    ...
    if gameObject then
        ...
        if textComponent then
            ...
            uid = uid:gsub("UID:", "<color=#ff99ff>w</color><color=#e899ff>i</color><color=#d999ff>n</color><color=#c999ff>d</color><color=#ba99ff>y</color><color=#ab99ff>:</color>")
            uid = uid:gsub("CNBETAWin2.0.54_D6648440_A6635239_L6635795", "")
            uid = uid:gsub(" ", "")
            textComponent.text = "<i><color=#00E6CF>"..uid.."</color></i>"
        else
